...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().productId(DEFAULT_PRODUCT_ID).name(DEFAULT_NAME).price(DEFAULT_PRICE).stock(DEFAULT_STOCK);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().productId(UPDATED_PRODUCT_ID).name(UPDATED_NAME).price(UPDATED_PRICE).stock(UPDATED_STOCK);
        return product;
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.productId(UPDATED_PRODUCT_ID).name(UPDATED_NAME).price(UPDATED_PRICE).stock(UPDATED_STOCK);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.productId(UPDATED_PRODUCT_ID).name(UPDATED_NAME).price(UPDATED_PRICE).stock(UPDATED_STOCK);
