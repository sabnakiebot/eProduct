...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().orderId(DEFAULT_ORDER_ID).orderNo(DEFAULT_ORDER_NO).totalAmount(DEFAULT_TOTAL_AMOUNT);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().orderId(UPDATED_ORDER_ID).orderNo(UPDATED_ORDER_NO).totalAmount(UPDATED_TOTAL_AMOUNT);
        return order;
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.orderId(UPDATED_ORDER_ID).orderNo(UPDATED_ORDER_NO).totalAmount(UPDATED_TOTAL_AMOUNT);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderId(UPDATED_ORDER_ID).totalAmount(UPDATED_TOTAL_AMOUNT);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderId(UPDATED_ORDER_ID).orderNo(UPDATED_ORDER_NO).totalAmount(UPDATED_TOTAL_AMOUNT);
